...
class AccountMove(models.Model):
    ...
    def action_post(self):
        moves = self.filtered(
            lambda x: x.l10n_br_edoc_policy == "directly" and x.move_type != "entry"
        )
...
class AccountMoveLine(models.Model):
    ...
    def get_eletronic_line_vals(self):
        ...
        icms = self.tax_ids.filtered(lambda x: x.domain == "icms")

        fiscal_pos = self.move_id.fiscal_position_id

        ipi_value = round(self.price_subtotal * ipi.amount / 100, 2)
        bc_icms_value = self.price_subtotal + ipi_value
        icms_value = round(bc_icms_value * icms.amount / 100, 2)
        ...
        vals = {
            ...
            "icms_base_calculo": bc_icms_value,
            ...
            # - COFINS -
            "cofins_cst": cofins.cofins_cst or "99",
